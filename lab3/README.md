...
## Цель работы: 
Научиться устанавливать разрешения NTFS для файлов и для папок для отдельных пользователей и групп в операционной системы Windows ХР, а также устранять проблемы доступа к ресурсам.
 
## Задача:
 Провести различные действия над папками под различными учетными записями.
...
**Доступы у папки Folderl2:**

![.](3.png)

**Разрешения у папки Folderl2:**
